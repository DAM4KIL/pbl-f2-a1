...
function explodeEye() {
  ...
  // Fix the background image syntax:
  blueSquare.style.backgroundImage = 'url("blueKey.png")';
  blueSquare.style.backgroundSize = 'contain';  // Add this to ensure proper sizing
  blueSquare.style.backgroundRepeat = 'no-repeat';
